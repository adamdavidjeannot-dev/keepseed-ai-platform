...
var stripeApiKey = process.env.STRIPE_SECRET_KEY || "sk_test_placeholder_key";
var stripe = new Stripe(stripeApiKey, {
...
app.post("/api/create-subscription-checkout", async (req, res) => {
  try {
    ...
    const session = await stripe.checkout.sessions.create({
      ...
      customer_email: !customerId ? customerEmail : void 0,
      line_items: [
        {
...
app.post("/api/create-topup-checkout", async (req, res) => {
  try {
